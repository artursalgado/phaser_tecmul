...
const config = {
  ...
  type: Phaser.AUTO,
  scale: {
    // Redimensiona o ecrã do jogo (aspect ratio)
  ...
  physics: {
    default: "arcade", // Utiliza o motor físico Arcade
    // (mais leve e rápido para jogos 2D simples)
    arcade: {
      gravity: { y: 0 }, //não há gravidade vertical padrão no mundo entao éZERO
      debug: false, // Define a 'true' para desenhar as hitboxes físicas
    },
  },
...
// arranca o jogo com a configuração definida

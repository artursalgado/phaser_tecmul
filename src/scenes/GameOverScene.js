...
export default class GameOverScene extends Phaser.Scene {
  ...
  create(data) {
    ...
    const titulo = this.add
      .text(W / 2, H / 2 - 130, I18n.t("gameover.title"), {
    ...
    const sub = this.add
      .text(W / 2, H / 2 - 60, I18n.t("gameover.subtitle"), {
        fontFamily: "Georgia, serif",
        fontSize: "17px",
        fill: "#c8a878",
        fontStyle: "italic",
    ...
    const textoEstatisticas = this.add
      .text(W / 2, H / 2 - 14, etiquetaEstatisticas, {
        fontFamily: "Georgia, serif",
        fontSize: "15px",
        fill: "#c8a878",
        fontStyle: "bold",
    ...
    this.add
      .text(W / 2, H - 24, I18n.t("gameover.keys"), {
        fontSize: "11px",
        fill: "#c8a870",
        stroke: "#000000",
        strokeThickness: 2,

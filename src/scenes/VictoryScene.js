...
export default class VictoryScene extends Phaser.Scene {
  ...
  create(data) {
    ...
    const bgHappy = this.add
      .image(W / 2, H / 2, "fim_happy")
      .setDepth(0)
      .setAlpha(0); // Imagem 2: Resgatado em casa

    // Overlay dourado semitransparente. Parâmetros de rectangle: (centro X, centro Y, largura, altura, cor castanha, opacidade)
    const overlay = this.add
      .rectangle(W / 2, H / 2, W, H, 0x1a1000, 0.35)
      .setDepth(1);
    ...
    const titulo = this.add
      .text(W / 2, H / 2 - 130, I18n.t("victory.title"), {
    ...
    const sub = this.add
      .text(W / 2, H / 2 - 68, I18n.t("victory.subtitle"), {
        fontFamily: "Georgia, serif",
        fontSize: "15px",
        fill: "#c8a878",
        fontStyle: "italic",
    ...
    const textoEstatisticas = this.add
      .text(W / 2, H / 2 - 4, etiquetaEstatisticas, {
        fontFamily: "Georgia, serif",
        fontSize: "15px",
        fill: "#c8a878",
        fontStyle: "bold",
    ...
    const btnRestart = makeBtn(
      ...
      260,
      46,
      I18n.t("victory.restart"),
      { alpha: 0 },
    );
    const btnMenu = makeBtn(
      this,
      W / 2,
      H / 2 + 111,
      260,

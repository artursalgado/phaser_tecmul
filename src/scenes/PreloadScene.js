  ...
  preload() {
    ...
    this.load.on("progress", (v) => {
      barra
        .clear()
        .fillStyle(0x7ec850)
        .fillRect(W / 2 - 200, H / 2 - 10, 400 * v, 20);
    });

    this.add
      .text(W / 2, H / 2 - 40, "A carregar... / Loading...", {
        fontSize: "22px",
        fill: "#ffffff",
        fontStyle: "bold",
      })
    ...
    this.load.image(
      "punyworld",
      `assets/tilesets/punyworld-overworld-tileset.png?v=${versao}`,
    );

    // Diretórios das spritesheets do jogador
    const FW = 96,
      FH = 64; // Largura e altura de cada frame da spritesheet
    const caminhaHumano = "assets/spritesheets/human/";

    // 3. Spritesheets do corpo base do jogador
    this.load.spritesheet(
      "player_base_idle",
      caminhaHumano + "base_idle_strip9.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_base_walk",
      caminhaHumano + "base_walk_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_base_run",
      caminhaHumano + "base_run_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_base_hurt",
      caminhaHumano + "base_hurt_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_base_death",
      caminhaHumano + "base_death_strip13.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_base_axe",
      caminhaHumano + "base_axe_strip10.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_base_mining",
      caminhaHumano + "base_mining_strip10.png",
      { frameWidth: FW, frameHeight: FH },
    );
    ...
    this.load.spritesheet(
      "player_hair_idle",
      caminhaHumano + "mophair_idle_strip9.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_hair_walk",
      caminhaHumano + "mophair_walk_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_hair_run",
      caminhaHumano + "mophair_run_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_hair_hurt",
      caminhaHumano + "mophair_hurt_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_hair_death",
      caminhaHumano + "mophair_death_strip13.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_hair_axe",
      caminhaHumano + "mophair_axe_strip10.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_hair_mining",
      caminhaHumano + "mophair_mining_strip10.png",
      { frameWidth: FW, frameHeight: FH },
    );
    ...
    this.load.spritesheet(
      "player_tools_idle",
      caminhaHumano + "tools_idle_strip9.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_tools_walk",
      caminhaHumano + "tools_walk_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_tools_run",
      caminhaHumano + "tools_run_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_tools_hurt",
      caminhaHumano + "tools_hurt_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_tools_axe",
      caminhaHumano + "tools_axe_strip10.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "player_tools_mining",
      caminhaHumano + "tools_mining_strip10.png",
      { frameWidth: FW, frameHeight: FH },
    );
    ...
    this.load.spritesheet(
      "goblin_idle",
      caminhaGoblin + "spr_idle_strip9.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "goblin_walk",
      caminhaGoblin + "spr_walk_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "goblin_hurt",
      caminhaGoblin + "spr_hurt_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "goblin_death",
      caminhaGoblin + "spr_death_strip13.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "goblin_attack",
      caminhaGoblin + "spr_attack_strip10.png",
      { frameWidth: FW, frameHeight: FH },
    );
    ...
    this.load.spritesheet(
      "skeleton_idle",
      caminhaEsqueleto + "skeleton_idle_strip6.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "skeleton_walk",
      caminhaEsqueleto + "skeleton_walk_strip8.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "skeleton_hurt",
      caminhaEsqueleto + "skeleton_hurt_strip7.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "skeleton_death",
      caminhaEsqueleto + "skeleton_death_strip10.png",
      { frameWidth: FW, frameHeight: FH },
    );
    this.load.spritesheet(
      "skeleton_attack",
      caminhaEsqueleto + "skeleton_attack_strip7.png",
      { frameWidth: FW, frameHeight: FH },
    );
    ...
    [
      ...
      "bluebar_00",
      "bluebar_05",
    ].forEach((k) => this.load.image(k, `assets/images/${k}.png`));

    // Elementos decorativos de árvores e jangada
    this.load.spritesheet(
      "spr_deco_tree_01_strip4",
      "assets/images/spr_deco_tree_01_strip4.png",
      { frameWidth: 32, frameHeight: 34 },
    );
    this.load.image(
      "spr_deco_coracle_land",
      "assets/images/spr_deco_coracle_land.png",
    );
    ...
    this.load.spritesheet("icons", "assets/images/ui/icons.png", {
      frameWidth: 16,
      frameHeight: 16,
    });
    ...
    [
      ...
      "intro_deriva",
      "intro_praia",
    ].forEach((k) => this.load.image(k, `assets/intro/${k}.png`));
